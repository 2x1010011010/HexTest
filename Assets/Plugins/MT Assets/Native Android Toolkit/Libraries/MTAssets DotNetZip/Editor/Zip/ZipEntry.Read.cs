...
namespace MTAssets.NativeAndroidToolkit.Editor.IonicDotNetZip.Zip
{
    public partial class ZipEntry
    {
        ...
        private static bool ReadHeader(ZipEntry ze, System.Text.Encoding defaultEncoding)
        {
            ...
            int signature = IonicDotNetZip.Zip.SharedUtilities.ReadEntrySignature(ze.ArchiveStream);
            bytesRead += 4;
            ...
            if (ZipEntry.IsNotValidSig(signature))
            {
                ...
                // workitem 10178
                IonicDotNetZip.Zip.SharedUtilities.Workaround_Ladybug318918(ze.ArchiveStream);
            ...
            ze._LastModified = IonicDotNetZip.Zip.SharedUtilities.PackedToDateTime(ze._TimeBlob);
            ...
            if (!ze._FileNameInArchive.EndsWith("/") && (ze._BitField & 0x0008) == 0x0008)
            {
                ...
                while (wantMore)
                {
                    ...
                    long d = IonicDotNetZip.Zip.SharedUtilities.FindSignature(ze.ArchiveStream, ZipConstants.ZipEntryDataDescriptorSignature);
                    if (d == -1) return false;
        ...
        internal static void HandlePK00Prefix(Stream s)
        {
            ...
            uint datum = (uint)IonicDotNetZip.Zip.SharedUtilities.ReadInt(s);
        ...
        private static void HandleUnexpectedDataDescriptor(ZipEntry entry)
        {
            ...
            {
                int sz = IonicDotNetZip.Zip.SharedUtilities.ReadInt(s);
                if (sz == entry._CompressedSize)
                {
                    sz = IonicDotNetZip.Zip.SharedUtilities.ReadInt(s);
