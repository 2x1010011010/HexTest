...
namespace MTAssets.NativeAndroidToolkit.Editor.IonicDotNetZip.Zip
{
    ...
    partial class ZipEntry
    {
        ...
        public string Info
        {
            get
            {
                ...
                .Append(string.Format("          Timeblob: 0x{0:X8}\n", this._TimeBlob))
                    .Append(string.Format("              Time: {0}\n", IonicDotNetZip.Zip.SharedUtilities.PackedToDateTime(this._TimeBlob)));
                                              ...
                                              Dictionary<String, Object> previouslySeen)
        {
            ...
            int signature = IonicDotNetZip.Zip.SharedUtilities.ReadSignature(s);
            ...
            unchecked
            {
                ...
                zde._LastModified = IonicDotNetZip.Zip.SharedUtilities.PackedToDateTime(zde._TimeBlob);
            ...
            {
                // UTF-8 is in use
                zde._FileNameInArchive = IonicDotNetZip.Zip.SharedUtilities.Utf8StringFromBuffer(block);
            }
            else
            {
                zde._FileNameInArchive = IonicDotNetZip.Zip.SharedUtilities.StringFromBuffer(block, expectedEncoding);
            }
            ...
            if (zde._commentLength > 0)
            {
                ...
                {
                    // UTF-8 is in use
                    zde._Comment = IonicDotNetZip.Zip.SharedUtilities.Utf8StringFromBuffer(block);
                }
                else
                {
                    zde._Comment = IonicDotNetZip.Zip.SharedUtilities.StringFromBuffer(block, expectedEncoding);
                }
            }
