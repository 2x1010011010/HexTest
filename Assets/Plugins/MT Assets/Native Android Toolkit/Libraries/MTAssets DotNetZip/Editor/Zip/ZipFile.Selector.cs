...
namespace MTAssets.NativeAndroidToolkit.Editor.IonicDotNetZip.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            IonicDotNetZip.FileSelector ff = new IonicDotNetZip.FileSelector(selectionCriteria,
...
namespace MTAssets.NativeAndroidToolkit.Editor.IonicDotNetZip
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(IonicDotNetZip.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(IonicDotNetZip.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(IonicDotNetZip.Zip.ZipEntry entry)
        {
        ...
        public ICollection<IonicDotNetZip.Zip.ZipEntry> SelectEntries(IonicDotNetZip.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<IonicDotNetZip.Zip.ZipEntry>();

            foreach (IonicDotNetZip.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<IonicDotNetZip.Zip.ZipEntry> SelectEntries(IonicDotNetZip.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
