...
using System.IO;
using MTAssets.NativeAndroidToolkit.Editor.IonicDotNetZip.Zip;
...
namespace MTAssets.NativeAndroidToolkit.Editor.IonicDotNetZip.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            CompressionLevel = IonicDotNetZip.Zlib.CompressionLevel.Default;
            ...
            Strategy = IonicDotNetZip.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        /// </remarks>
        public IonicDotNetZip.Zlib.CompressionStrategy Strategy
        {
            get;
            set;
        }
        ...
        /// </summary>
        public IonicDotNetZip.Zip.CompressionMethod CompressionMethod
        {
            get;
            set;
        }
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = IonicDotNetZip.Zip.ZipOutputStream.DefaultEncoding;
        ...
        private IonicDotNetZip.Crc.CrcCalculatorStream _entryOutputStream;
        private bool _needToWriteEntryHeader;
        private string _name;
        private bool _DontIgnoreCase;
#if !NETCF
        internal IonicDotNetZip.Zlib.ParallelDeflateOutputStream ParallelDeflater;
...
#if !NETCF
        public IonicDotNetZip.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
