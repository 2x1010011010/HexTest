...
namespace MTAssets.NativeAndroidToolkit.Editor.IonicDotNetZip.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        public ZipEntry()
        {
            ...
            _CompressionLevel = IonicDotNetZip.Zlib.CompressionLevel.Default;
        ...
        public DateTime LastModified
        {
            ...
            set
            {
                _LastModified = (value.Kind == DateTimeKind.Unspecified)
                    ...
                    : value.ToLocalTime();
                _Mtime = IonicDotNetZip.Zip.SharedUtilities.AdjustTime_Reverse(_LastModified).ToUniversalTime();
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)IonicDotNetZip.Zip.CompressionMethod.None)
                    _CompressionLevel = IonicDotNetZip.Zlib.CompressionLevel.None;
                else if (CompressionLevel == IonicDotNetZip.Zlib.CompressionLevel.None)
                    _CompressionLevel = IonicDotNetZip.Zlib.CompressionLevel.Default;
        ...
        ///
        /// <seealso cref="CompressionMethod"/>
        public IonicDotNetZip.Zlib.CompressionLevel CompressionLevel
        {
            get
            {
            ...
            set
            {
                ...
                if (value == IonicDotNetZip.Zlib.CompressionLevel.Default &&
                    _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;

                if (value == IonicDotNetZip.Zlib.CompressionLevel.None &&
                    _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                if (_CompressionLevel == IonicDotNetZip.Zlib.CompressionLevel.None)
                    _CompressionMethod = (short)IonicDotNetZip.Zip.CompressionMethod.None;
                else
                    _CompressionMethod = (short)IonicDotNetZip.Zip.CompressionMethod.Deflate;
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    AlternateEncoding = IonicDotNetZip.Zip.ZipFile.DefaultEncoding;
                    AlternateEncodingUsage = ZipOption.Never;
                }
            }
        }
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            if (String.IsNullOrEmpty(nameInArchive))
                throw new IonicDotNetZip.Zip.ZipException("The entry name must be non-null and non-empty.");
            ...
            else
            {
                ...
                if (String.IsNullOrEmpty(filename))
                    throw new IonicDotNetZip.Zip.ZipException("The filename must be non-null and non-empty.");
        ...
        private void SetFdpLoh()
        {
            ...
            try
            {
                ...
                // workitem 10178
                IonicDotNetZip.Zip.SharedUtilities.Workaround_Ladybug318918(this.ArchiveStream);
            }
        ...
        private IonicDotNetZip.Zlib.CompressionLevel _CompressionLevel;
