...
namespace MTAssets.NativeAndroidToolkit.Editor.IonicDotNetZip.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        public IonicDotNetZip.Crc.CrcCalculatorStream OpenReader()
        {
            // workitem 10923
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public IonicDotNetZip.Crc.CrcCalculatorStream OpenReader(string password)
        {
            // workitem 10923
            if (_container.ZipFile == null)
                throw new InvalidOperationException("Use OpenReader() only with ZipFile.");
        ...
        internal IonicDotNetZip.Crc.CrcCalculatorStream InternalOpenReader(string password)
        {
            ValidateCompression();
            ValidateEncryption();
            ...
            return new IonicDotNetZip.Crc.CrcCalculatorStream(input3, LeftToRead);
        }
        ...
        private Int32 ExtractOne(Stream output)
        {
            ...
            try
            {
                ...
                // workitem 10178
                IonicDotNetZip.Zip.SharedUtilities.Workaround_Ladybug318918(input);
                ...
                using (var s1 = new IonicDotNetZip.Crc.CrcCalculatorStream(input3))
                {
                    while (LeftToRead > 0)
                    {
        ...
        internal Stream GetExtractDecompressor(Stream input2)
        {
            ...
            switch (_CompressionMethod_FromZipFile)
            {
                ...
                case (short)CompressionMethod.Deflate:
                    return new IonicDotNetZip.Zlib.DeflateStream(input2, IonicDotNetZip.Zlib.CompressionMode.Decompress, true);
#if BZIP
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            try
            {
                ...
                {
                    // workitem 6191
                    DateTime AdjustedLastModified = IonicDotNetZip.Zip.SharedUtilities.AdjustTime_Reverse(LastModified);
