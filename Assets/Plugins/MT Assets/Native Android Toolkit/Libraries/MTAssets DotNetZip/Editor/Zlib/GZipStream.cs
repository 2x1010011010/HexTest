...
namespace MTAssets.NativeAndroidToolkit.Editor.IonicDotNetZip.Zlib
{
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        public override long Position
        {
            get
            {
                if (this._baseStream._streamMode == IonicDotNetZip.Zlib.ZlibBaseStream.StreamMode.Writer)
                    return this._baseStream._z.TotalBytesOut + _headerByteCount;
                if (this._baseStream._streamMode == IonicDotNetZip.Zlib.ZlibBaseStream.StreamMode.Reader)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == IonicDotNetZip.Zlib.ZlibBaseStream.StreamMode.Undefined)
            {
