...
using MTAssets.NativeAndroidToolkit.Editor.IonicDotNetZip.Zlib;
using System.IO;


namespace MTAssets.NativeAndroidToolkit.Editor.IonicDotNetZip.Zlib
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        IonicDotNetZip.Zlib.CompressionLevel compressLevel,
    ...
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int _Crc32;
        private IonicDotNetZip.Crc.CRC32 _runningCrc;
        ...
        private IonicDotNetZip.Zlib.CompressionLevel _compressLevel;
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new IonicDotNetZip.Crc.CRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                IonicDotNetZip.Crc.CRC32 crc = new IonicDotNetZip.Crc.CRC32();
