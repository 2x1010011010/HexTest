...
namespace MTAssets.NativeAndroidToolkit.Editor
{
    ...
    class Greetings
    {
        ...
        public static string assetName = "Native Android Toolkit";
        public static string pathForThisAsset = "Assets/Plugins/MT Assets/Native Android Toolkit";
        public static string pathForThisAssetDocumentation = "/_Documentation/Documentation (Open With Browser).html";
        public static string optionalObservation = "REMINDER: The Native Android Toolkit needs to be initialized on the first scene executed by your game for everything to work as expected. Read the documentation to find out how to do this.";
        public static string pathToGreetingsFile = "Assets/Plugins/MT Assets/_AssetsData/Greetings/GreetingsData.Nat.ini";
