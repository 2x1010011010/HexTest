...
namespace MTAssets.NativeAndroidToolkit.Editor
{
    ...
    public class Menu : MonoBehaviour
    {
        ...
        [MenuItem("Tools/MT Assets/Native Android Toolkit/Dependencies Resolver", false, 10)]
        static void DependenciesResolver()
        {
            LibsResolver.RunNativeAndroidToolkitDependenciesResolver(true);
        }

        [MenuItem("Tools/MT Assets/Native Android Toolkit/View Changelog", false, 10)]
        ...
        [MenuItem("Tools/MT Assets/Native Android Toolkit/Get Support", false, 30)]
